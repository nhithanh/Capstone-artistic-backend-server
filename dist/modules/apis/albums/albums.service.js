...
let AlbumsService = class AlbumsService {
    ...
    async findOne(id) {
        ...
        medias = medias.map(media => {
            if (media.type === media_entity_1.MEDIA_TYPE.VIDEO) {
                return Object.assign(Object.assign({}, media), { thumbnailURL: this.s3Service.getCDNURL(media.storageLocation + "/thumbnail.png"), originalVideoURL: this.s3Service.getCDNURL(media.storageLocation + "/original.mp4"), playlist: this.s3Service.getCDNURL(media.storageLocation + "/playlist.m3u8") });
            }
    ...
    async update(id, user, updateAlbumDto) {
        ...
        if (isHasRight) {
            ...
            const updatedAlbum = await this.albumRepository.save(Object.assign(Object.assign({}, updateAlbum), updateAlbumDto));
            return Object.assign(Object.assign({}, updatedAlbum), { thumbnailURL: this.s3Service.getCDNURL(updatedAlbum.thumbnailURL) });
        }
        else {
